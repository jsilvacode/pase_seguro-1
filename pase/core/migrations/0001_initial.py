# Generated by Django 3.2.6 on 2021-08-06 23:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('actividad_academica', models.ForeignKey(help_text='Eventos.', on_delete=django.db.models.deletion.CASCADE, to='core.actividadacademica', verbose_name='actividades académicas')),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(related_name='get_faculty_career', to='core.AntecedentesAcademicos', verbose_name='facultad / carrera'),
        ),
    ]
